...
class PersonalInfoController extends Controller
{
    public function show(ModelsPersonalInformation $asset)
    {
        ...
        // $additionalAssets = PersonalInfoAssets::where('user_id', $id)->latest()->get();
        return view('lifespot.mylifespot.personal_info.show',compact('user', 'asset','medical','activity','work','spouse','education','military'));
    }
