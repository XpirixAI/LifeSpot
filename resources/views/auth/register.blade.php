    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="uname" class="block mt-1 w-full" type="text" name="uname" :value="old('uname')" required autofocus autocomplete="uname" />
            </div>
            ...
            <div class="mt-4">
                <x-jet-label for="dev_pass" value="{{ __('Developer Password') }}" />
                <x-jet-input id="dev_pass" class="block mt-1 w-full" type="password" name="dev_pass" required />
            </div>
