    ...
    >
        ...
        <div class="col-span-4 lg:col-span-1 bg-white pt-6 px-3 pb-3">
            ...
            <ul class="space-y-3 mb-5">
                <li>
                    <a class="flex space-x-2 text-xs" href="#!">
                        <span>
            ...
            <ul class="space-y-3 mb-5">
                <li class="{{ $cat_id == 0 ? 'bg-blue-50' : '' }} hover:bg-blue-50 rounded-lg w-full py-1">
                    <a class="flex space-x-2 text-xs items-center" href="{{route('documents', 0)}}">
                        ...
                        <div class="{{ $cat_id == 0 ? 'font-bold' : '' }}">Estate Profile (3)</div>
                    </a>
                </li>
                <li class="{{ $cat_id == 1 ? 'bg-blue-50' : '' }} hover:bg-blue-50 hover:rounded-lg w-full py-1">
                    <a class="flex space-x-2 text-xs items-center" href="{{route('documents', 1)}}">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z" />
                            </svg>
                        </span>
                        <div class="{{ $cat_id == 1 ? 'font-bold' : '' }}">Financial & Retirement (4)</div>
                    </a>
                </li>
                <li class="{{ $cat_id == 2 ? 'bg-blue-50' : '' }} hover:bg-blue-50 hover:rounded-lg w-full py-1">
                    <a class="flex space-x-2 text-xs items-center" href="{{route('documents', 2)}}">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z" />
                            </svg>
                        </span>
                        <div class="{{ $cat_id == 2 ? 'font-bold' : '' }}">Health & Ongoing Care (6)</div>
                    </a>
                </li>
                <li class="{{ $cat_id == 3 ? 'bg-blue-50' : '' }} hover:bg-blue-50 hover:rounded-lg w-full py-1">
                    <a class="flex space-x-2 text-xs items-center" href="{{route('documents', 3)}}">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z" />
                            </svg>
                        </span>
                        <div class="{{ $cat_id == 3 ? 'font-bold' : '' }}">Work & Education (5)</div>
                    </a>
                </li>
            </ul>
            <div class="flex justify-between mb-3">
            ...
            <ul class="space-y-3 mb-5">
                <li class="hover:bg-blue-50 hover:rounded-lg w-full py-1">
                    <a class="flex space-x-2 text-xs items-center" href="#!">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z" />
                            </svg>
                        </span>
                        <div class="">Family (0)</div>
                    </a>
                </li>
                <li class="hover:bg-blue-50 hover:rounded-lg w-full py-1">
                    <a class="flex space-x-2 text-xs items-center" href="#!">
                ...
                <li class="hover:bg-blue-50 hover:rounded-lg w-full py-1">
                    <a class="flex space-x-2 text-xs items-center" href="#!">
                        ...
                        <div class="">Kides (0)</div>
                    </a>
                </li>
                <a class="text-xs text-blue-500" href="#!">Add a Folder</a>
            </ul>
        </div>
            ...
            <div class="pt-6 px-3 pb-3">
                <div class="flex justify-between">
                    <div class="flex items-center space-x-3 mb-4">
                        <h2 class="font-black text-lg ">Estate Profile</h2>
                        <a href="#!">
                ...
                <div class="flex justify-between mt-3 items-center mb-5">
                    ...
                    <div class="flex space-x-3 mr-3">
                        <form class="my-2 lg:w-72">
                            <label for="default-search" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-gray-300">Search</label>
                            <div class="relative mr-2">
                                <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                                    <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                                </div>
                                <input type="search" id="default-search" class="block pl-10 w-full text-xs text-gray-900 bg-white xrounded-lg border border-gray-100 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required="">
                            </div>
                        </form>
                ...
                <form method="post" action="{{route('documents.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-4 pt-5 pb-2">
                        <div>
                            ...
                            <select name="folder" class="form-select w-full bg-gray-100 border border-gray-300 rounded-md">
                                <option value="" disabled selected>Select a Folder</option>
                                <option value="0">Estate Profile</option>
                                <option value="1">Financial & Retirement</option>
                                <option value="2">Health & Ongoing Care</option>
                                <option value="3">Work & Education</option>
                            </select>
            ...
            >
                ...
                <div id="doc_details_content">
                    <form method="POST" action="{{route('document.update')}}">
                        ...
                        <select id="detail_modal_category" class="form-select w-full bg-gray-100 border border-gray-300 mb-5 rounded-md" name="category">
                            <option value="" disabled selected>Select a Folder</option>
                            <option value="0">Estate Profile</option>
                            <option value="1">Financial & Retirement</option>
                            <option value="2">Health & Ongoing Care</option>
            ...
            Alpine.data('data', () => ({
                ...
                getDocumentDetails() {
                    ...
                    $.ajax({
                        ...
                        // TODO:
                        // This should be a GET route, but a bug was causing the route to not execute the controller errors.
