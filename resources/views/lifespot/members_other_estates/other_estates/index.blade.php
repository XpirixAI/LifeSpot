    ...
    <div class="grid lg:grid-cols-4 gap-4 mt-5">
                      ...
                      <div class="text-gray-900 text-xl leading-tight font-medium mb-8">
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img class="h-12 w-12 rounded-full" src="{{ asset('img/WalkerFamilyPics/brandon.png') }}" alt="">
                                <div class="text-sm">
                ...
                <div>
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
                      <div class="text-gray-900 text-xl leading-tight font-medium mb-8">
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img class="h-12 w-12 rounded-full" src="{{ asset('img/WalkerFamilyPics/sara.png') }}" alt="">
                                <div class="text-sm">
                                    <span  class="font-bold text-blue-900">Sara Walker</span>
                                    <div class="text-gray-700">Spouse</div>
                                <div  class="flex px-2 pt-1 bg-gray-100 whitespace-nowrap text-gray-500 font-bold text-xs leading-tight uppercase rounded-full shadow-md">Co-Trustee
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex justify-end">
                                <button type="button" class="flex  px-2 pt-1 bg-blue-100 whitespace-nowrap text-blue-900 font-bold text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-200 hover:shadow-lg focus:bg-blue-200 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-300 active:shadow-lg transition duration-150 ease-in-out">jointly shared
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-2 pb-1">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                    </svg>
                                </button>
                ...
                <div>
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
                      <div class="text-gray-900 text-xl leading-tight font-medium mb-8">
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img class="h-12 w-12 rounded-full" src="{{ asset('img/WalkerFamilyPics/howard.png') }}" alt="">
                                <div class="text-sm">
                                    <span  class="font-bold text-blue-900">Howard Walker</span>
                                    <div class="text-gray-700">Father</div>
                ...
                <div>
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
                      <div class="text-gray-900 text-xl leading-tight font-medium mb-8">
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img class="h-12 w-12 rounded-full" src="{{ asset('img/WalkerFamilyPics/brian.jpeg') }}" alt="">
                                <div class="text-sm">
                                    <span  class="font-bold text-blue-900">brian Agster</span>
                                    <div class="text-gray-700">Best Friend</div>
                                <div  class="flex px-2 pt-1 bg-gray-100 whitespace-nowrap text-gray-500 font-bold text-xs leading-tight uppercase rounded-full shadow-md">Co-Executor
                                </div>
                                </div>
                            </div>
                             <span class="text-2xl font-bold text-right">...</span>
                      ...
                      <div class="text-gray-900 text-xl leading-tight font-medium mb-8">
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                ...
                                <div class="text-sm">
                                    <span  class="font-bold text-blue-900">{{ Auth::user()->fname }} {{ Auth::user()->lname }}</span>
                                    <div class="text-gray-700">Advisor</div>
                                <div  class="flex px-2 pt-1 bg-gray-100 whitespace-nowrap text-gray-500 font-bold text-xs leading-tight uppercase rounded-full shadow-md">Trustee
                                </div>
                                </div>
                ...
                <div>
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
                      <div class="text-gray-900 text-xl leading-tight font-medium mb-8">
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img class="h-12 w-12 rounded-full" src="{{ asset('img/WalkerFamilyPics/vienna.png') }}" alt="">
                                <div class="text-sm">
                                    <span  class="font-bold text-blue-900">Vienna Walker</span>
                                    <div class="text-gray-700">Daughter</div>
                                <div  class="flex px-2 pt-1 bg-gray-100 whitespace-nowrap text-gray-500 font-bold text-xs leading-tight uppercase rounded-full shadow-md">Heir
                                </div>
                                </div>
                            </div>
                             <span class="text-2xl font-bold text-right">...</span>
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex justify-end">
                                <button type="button" class="flex  px-2 pt-1 bg-blue-100 whitespace-nowrap text-blue-900 font-bold text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-200 hover:shadow-lg focus:bg-blue-200 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-300 active:shadow-lg transition duration-150 ease-in-out">dependent
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-2 pb-1">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                    </svg>
                                </button>
                ...
                <div>
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
                      <div class="text-gray-900 text-xl leading-tight font-medium mb-8">
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img class="h-12 w-12 rounded-full" src="{{ asset('img/WalkerFamilyPics/rocco.png') }}" alt="">
                                <div class="text-sm">
                                    <span  class="font-bold text-blue-900">Rocco Walker</span>
                                    <div class="text-gray-700">Son</div>
                                <div  class="flex px-2 pt-1 bg-gray-100 whitespace-nowrap text-gray-500 font-bold text-xs leading-tight uppercase rounded-full shadow-md">Heir
                                </div>
                                </div>
                            </div>
                ...
                <div>
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
                      <div class="text-gray-900 text-xl leading-tight font-medium mb-8">
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img class="h-12 w-12 rounded-full" src="{{ asset('img/WalkerFamilyPics/florence.png') }}" alt="">
                                <div class="text-sm">
                                    <span  class="font-bold text-blue-900">Florence Walker</span>
                                    <div class="text-gray-700">Grandmother</div>
                                <div  class="flex px-2 pt-1 bg-gray-100 whitespace-nowrap text-gray-500 font-bold text-xs leading-tight uppercase rounded-full shadow-md">Heir
                                </div>
                                </div>
                            </div>
        ...
        <div class="hidden md:block space-y-4">
            ...
            <div class="hidden lg:block ">
                <div class="h-72 bg-blue-50 rounded-xl p-6 mx-4">
