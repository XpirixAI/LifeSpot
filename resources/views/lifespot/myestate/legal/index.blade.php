...
@section('financials') --}}
    ...
    {{-- <li class="mx-2 mb-5">
        <a href="{{ route('myestate.financials.add.bank') }}" class="flex justify-center h-40 items-center bg-gray-50 rounded-xl border border-gray-100 p-2">
            <div class="rounded-lg bg-white max-w-sm">
                <div class="bg-gray-50 max-w-sm r">
                        ...
                        <div class="text-center p-3">
                            <h5 class="text-blue-900 text-xs font-bold mb-1">Add a Bank</h5>
                        </div>
                </div>
            </div>
        </a>
    ...
    @foreach ($assets as $asset)
        <li class="relative mx-2 mb-5">
            <a href="{{ route('myestate.financials.show.bank', $asset->id) }}" class="flex justify-center h-40  rounded-xl border border-gray-100 p-6">
                <div class="rounded-lg bg-white max-w-sm">
                ...
                <form method="POST" action="{{ route('myestate.financials.destroy.bank',$asset->id)  }}">
                    @csrf
                    @method('DELETE')
