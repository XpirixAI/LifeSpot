    ...
    <div class="ml-6 mt-6 mx-6">
        ...
        <div class="grid grid-cols-5 gap-4">
            <div>
                ...
                <a class="" href="{{ route('myestate.financials.tax') }}">
                    <div class="hover:bg-blue-50 hover:text-blue-900 hover:font-bold py-1 text-sm rounded-lg pl-3 mb-2 {{ Route::is('myestate.financials.tax*') ? 'bg-blue-50 text-blue-900 font-bold ' : '' }}">
                        Taxes
                    </div>
                </a>
            </div>
