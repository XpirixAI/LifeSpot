...
<form method="POST" action="{{ route('mylifespot.home_property.store_asset') }}" enctype="multipart/form-data">
    @csrf
            ...
            <div class="col-span-4 lg:col-span-3 space-y-3 px-4">
                <div class="lg:flex lg:space-x-2 space-y-4 lg:space-y-0">
                    <div class="lg:w-2/3">
                        ...
                        <input type="text" name="name"  autocomplete="name" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('name') }}" placeholder="Asset Name">
                        @error('name')
                            <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="lg:w-1/3">
                        ...
                        <input type="text" name="value"  autocomplete="value" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('value') }}" placeholder="$">
                        @error('value')
                            <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="lg:flex lg:space-x-2 space-y-4 lg:space-y-0">
                    <div class="lg:w-full">
                        <label for="location" class="block text-sm font-black text-black">Description/Asset Location</label>
                        <input type="text" name="location"  autocomplete="location" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('location') }}" placeholder="Description/Asset Location">
                        @error('location')
                            <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="pt-8">
                    <a href="{{ route('mylifespot.home_property.property') }}" class="border border-gray-400 rounded-lg float-right font-semibold text-xs py-2 px-4">Cancel</a>
