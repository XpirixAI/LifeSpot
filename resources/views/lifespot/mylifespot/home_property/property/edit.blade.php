...
@method('PUT')
    ...
    <div class="grid lg:grid-cols-5 gap-4">
        <div class="col-span-4 lg:col-span-1 xmax-h-48 xw-auto lg:border-r px-2 xmx-4">
            <a class="lg:hidden flex text-sm text-blue-800 font-semibold mb-4" href="{{ route('mylifespot.home_property.asset',$asset->id) }}">
            ...
            <div class="col-span-4 lg:col-span-3 space-y-3 px-4">
                ...
                <div class="lg:flex lg:space-x-2 space-y-4 lg:space-y-0">
                    <div class="lg:w-full">
                        <label for="location" class="block text-sm font-black text-black">Discription/Asset Location</label>
