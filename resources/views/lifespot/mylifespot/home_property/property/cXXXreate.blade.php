    ...
    <div class="grid lg:grid-cols-5 gap-4">
        <div class="col-span-2 lg:col-span-1 xmax-h-48 xw-auto">
            <div class="relative top-0 left-0 xh-full">
                <img id="showImage" class="rounded-lg max-h-72 h-auto w-full object-cover" src="{{ (!empty($asset->thumbnail))? url($asset->thumbnail):asset('thumbnails/default.jpeg') }}" alt="no image">
                <img class="object-cover" src="{{ old('image') }}" alt="">
        <style>
            .image-upload>input {
        display: none;
        }
        ...
        <div class="col-span-4 lg:col-span-3 space-y-3">
           ...
           <div>
                ...
                value="{{ old('location') }}" placeholder="Asset's location">
                @error('location')
                    <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                @enderror
           </div>
