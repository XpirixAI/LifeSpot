...
@section('property')
    ...
    <li class="my-3 lg:my-0">
        <a href="{{ route('mylifespot.home_property.add.real_estate') }}" class="flex justify-center h-48 items-center bg-gray-50 rounded-xl border border-gray-100 p-2">
    ...
    @foreach ($assets as $asset)
        <li class="relative my-3 lg:my-0">
            <a href="{{ route('mylifespot.home_property.realestate', $asset->id) }}" class="flex justify-center h-48 rounded-xl border border-gray-100 p-2">
                <div class="rounded-lg bg-white max-w-sm">
