...
<!--Display Real Estate's Core Information -->
<div class="grid grid-cols-1 lg:grid-cols-5 lg:gap-x-2 gap-y-3 lg:grid-flow-row-dense mx-1 lg:mx-4">
    <div class="xbg-red-500 rounded-lg xshadow-xl min-h-20 row-span-6">
        <a class="flex text-sm text-blue-800 font-semibold mb-4" href="{{ route('mylifespot.home_property.real_estate') }}">
        ...
        <div class="flex space-x-8 mb-2">
                ...
                <a href="{{ route('mylifespot.home_property.edit.real_estate',$asset->id) }}"  class="flex">
                    <span class="text-blue-500">Edit</span>
                    </a>
        </div>
        <div class="mt-3">
            <img class="rounded-lg lg:min-h-36 lg:max-h-48 w-full lg:w-auto object-cover" src="{{ (!empty($asset->thumbnail))? asset($asset->thumbnail):url('thumbnails/default.jpeg') }}" alt="no image">
        </div>
    ...
    <div class="xbg-orange-500 rounded-lg xshadow-xl min-h-20 row-span-5 col-span-3 mt-5">
        <div class="grid grid-cols-7 gap-2 ">
            <div class="col-span-2 text-right mr-1 xspace-y-3">
                <div class="mb-3 ">Property <span class="hidden lg:inline"> Name</span>:</div>
                <div class="">
                    <div class=""><span class="hidden lg:inline"> Property</span> Address:</div>
...
<div class="mx-4">
    ...
    <div class="items-center space-y-3">
        ...
        <livewire:lien-holder :asset="$asset">
        ...
        <div class="mt-2 space-y-3 col-span-5 items-center lg:text-base text-sm">
            <div class="xbg-gray-400 grid grid-cols-8 lg:grid-cols-12 gap-0 lg:gap-4 items-center whitespace-nowrap">
                <div class="xbg-green-400 col-span-3 lg:col-span-3 text-right space-y-3">
                    <p class="text-gray-800">Mortage Lien(s)
        ...
        <div x-data="{open: false}" >
            <form method="POST" action="{{ route('store.multi.image.real_estate',$asset->id) }}" enctype="multipart/form-data" multiple="" class="border-none">
                @csrf
        ...
        <div class="ml-5">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-6 gap-4">
                ...
                <!-- Modal toggle -->
                    ...
                    <form method="POST" action="{{ route('destroy.mulit.image.real_estate',$additionalAsset->id)  }}">
                        @csrf
                        @method('DELETE')
