...
<form method="POST" action="{{ route('mylifespot.family.update.dependent',$asset->id) }}" enctype="multipart/form-data">
    @csrf
@method('PUT')
    ...
    <div class="grid lg:grid-cols-5 gap-4">
        <div class="col-span-4 lg:col-span-1 xmax-h-48 xw-auto lg:border-r px-2 xmx-4">
            <a class="lg:hidden flex text-sm text-blue-800 font-semibold mb-4" href="{{ route('mylifespot.family.update.emergency_contact',$asset->id) }}">
...
<!--QUESTIONS-->
        <div class="col-span-4 lg:col-span-3 space-y-3 px-4">
          ...
          <div class="py-2 lg:py-6">
            ...
            <div class="pt-8">
                <a href="{{ route('mylifespot.family.show.dependent',$asset->id) }}" class="border border-gray-400 rounded-lg float-right font-semibold text-xs py-2 px-4">Cancel</a>
