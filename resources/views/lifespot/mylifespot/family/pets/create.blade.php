...
<form method="POST" action="{{ route('mylifespot.family.store.pet') }}" enctype="multipart/form-data">
    @csrf
            ...
            <div class="col-span-4 lg:col-span-3 space-y-3 px-4">
                ...
                <div class="lg:flex lg:space-x-2 space-y-4 lg:space-y-0">
                    <div class="lg:w-full">
                        ...
                        <input type="text" name="description"  autocomplete="description" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('description') }}" placeholder="Description">
                        @error('description')
                            <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="py-2 lg:py-6">
                ...
                {{-- <div class="lg:flex lg:space-x-2 space-y-4 lg:space-y-0">
                    <div class="lg:w-full">
                        ...
                        <input type="text" name="emergency_contact"  autocomplete="emergency_contact" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('emergency_contact') }}" placeholder="Emergency Contact">
                ...
                <div class="pt-8">
                    <a href="{{ route('mylifespot.family.pets') }}" class="border border-gray-400 rounded-lg float-right font-semibold text-xs py-2 px-4">Cancel</a>
