...
<form method="POST" action="{{ route('mylifespot.family.store.beneficary') }}" enctype="multipart/form-data">
    @csrf



    <div x-data="{entity: 'Person'}" class="grid lg:grid-cols-5 gap-4">
        <div class="col-span-4 lg:col-span-1 xmax-h-48 xw-auto lg:border-r px-2 xmx-4">
            ...
            <div id="Person" x-show="entity == $el.id" class="lg:bg-gray-50 rounded-lg mt-5 px-2 py-4">
                <div class="xmt-6">
        ...
        <div class="col-span-4 lg:col-span-3 space-y-3 px-4">
            <h5 class="text-sm font-black text-black">Select whether this beneficiary is an Instution/Entity/Organization or a person?</h5>
            <div class="flex space-x-3 items-center pb-5">

                <div class="items-center"> <input name="isEntity" type="radio" value="Person" x-model="entity" checked  ><label for="person"></label> Person</div>

                <div class="items-center"><input name="isEntity" type="radio" value="Entity" x-model="entity" ><label for="entity"></label> Entity</div>


            </div>

            <div id="Person" x-show="entity == $el.id" class="lg:flex lg:space-x-2 space-y-4 lg:space-y-0">
                <div id="Person" class="lg:w-1/2">
            ...
            <!--ENTITY-->
            <div id="Entity" x-show="entity == $el.id"   class="lg:flex lg:space-x-2 space-y-4 lg:space-y-0">

                <div class="lg:w-full">
                    <label for="entity_name" class="block text-sm font-black text-black">Institution/Organization/Entity Name</label>
                    <input type="text" name="entity_name"  autocomplete="entity_name" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('entity_name') }}" placeholder="Name of Institution/Organization">
                    @error('entity_name')
                        <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                    @enderror
                </div>
          ...
          <div  id="Person" x-show="entity == $el.id" class="py-2 lg:py-6">
            ...
            <div class="pt-8">
                <a href="{{ route('mylifespot.family.beneficeries') }}" class="border border-gray-400 rounded-lg float-right font-semibold text-xs py-2 px-4">Cancel</a>
            ...
            <div class="col-span-4 lg:col-span-1 xmr-4 px-1 lg:px-4">
                <div class="h-72 overflow-y-auto bg-blue-50 rounded-xl p-6">
                    ...
                    <p class="mt-2 text-xs">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempore nisi, numquam id autem reiciendis hic doloribus pariatur eos perspiciatis mollitia esse cupiditate quibusdam at possimus temporibus. Ipsam expedita quos ullam.</p>
                </div>
            </div>
...
<ul class="md:col-span-12 lg:col-span-3 col-span-12 mb-12 mt-8  space-y-8 mx-1">
    <li class="max-h-72 overflow-y-auto bg-blue-50 rounded-xl p-6">
        <div class="rounded-full w-8 h-8 fond-black bg-blue-500 text-white text-xl py-1 px-3 mb-2">?</div>
        <h3 class="text-black font-black text-xl">Advertise Here</h3>
        <p class="mt-2 text-xs">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Itaque atque inventore nisi, cupiditate recusandae.</p>
    </li>
