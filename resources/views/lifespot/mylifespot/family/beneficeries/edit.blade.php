...
<form method="POST" action="{{ route('mylifespot.family.update.beneficary',$asset->id) }}" enctype="multipart/form-data">
    @csrf
@method('PUT')

    <div class="grid lg:grid-cols-5 gap-4">
        <div class="col-span-4 lg:col-span-1 xmax-h-48 xw-auto lg:border-r px-2 xmx-4">
            <a class="lg:hidden flex text-sm text-blue-800 font-semibold mb-4" href="{{ route('mylifespot.family.show.beneficary',$asset->id) }}">
        ...
        <div class="col-span-4 lg:col-span-3 space-y-3 px-4">
            <div class="lg:flex lg:space-x-2 space-y-4 lg:space-y-0">
                ...
                <div class="lg:w-full">
                    ...
                    <input type="text" name="entity_name"  autocomplete="entity_name" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('entity_name', $asset->entity_name) }}" placeholder="Name of Institution/Organization/Entity">
                    @error('entity_name')
                        <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="lg:flex lg:space-x-2 space-y-4 lg:space-y-0">
                <div class="lg:w-1/2">
                    ...
                    <input type="text" name="email"  autocomplete="email" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('email',$asset->email) }}" placeholder="Email">
                    @error('email')
                        <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                    @enderror
                </div>
               ...
               <div class="lg:w-1/2">
                    ...
                    value="{{ old('phone',$asset->phone) }}" placeholder="Phone">
                    @error('phone')
                        <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                    @enderror
               </div>
            ...
            <div class="pt-8">
                <a href="{{ route('mylifespot.family.show.beneficary',$asset->id) }}" class="border border-gray-400 rounded-lg float-right font-semibold text-xs py-2 px-4">Cancel</a>
