...
<!--Display Emergency's Core Information -->
<div class="grid grid-cols-1 lg:grid-cols-5 lg:gap-x-2 gap-y-3 lg:grid-flow-row-dense mx-1 lg:mx-4">
    <div class="xbg-red-500 rounded-lg xshadow-xl min-h-20 row-span-6">
        <a class="flex text-sm text-blue-800 font-semibold mb-4" href="{{ route('mylifespot.family.emergency-contacts') }}">
        ...
        <div class="flex space-x-8 mb-2">
                ...
                <h1 class="font-black text-xl">
                   ...
                   <a href="{{ route('mylifespot.family.edit.emergency_contact',$asset->id) }}" class="flex">
...
<div class="mx-4">
    ...
    <div class="items-center space-y-3">
        ...
        <div x-data="{open: false}" >
            <form method="POST" action="{{ route('store.multi.image.emergency-contacts',$asset->id) }}" enctype="multipart/form-data" multiple="" class="border-none">
                @csrf
        ...
        <div class="ml-5">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-6 gap-4">
                ...
                <!-- Modal toggle -->
                    ...
                    <form method="POST" action="{{ route('destroy.mulit.image.emergency-contacts',$additionalAsset->id)  }}">
                        @csrf
                        @method('DELETE')
