...
<form method="POST" action="{{ route('mylifespot.family.update.emergency_contact',$asset->id) }}" enctype="multipart/form-data">
    @csrf
@method('PUT')

    <div class="grid lg:grid-cols-5 gap-4">
        <div class="col-span-4 lg:col-span-1 xmax-h-48 xw-auto lg:border-r px-2 xmx-4">
            <a class="lg:hidden flex text-sm text-blue-800 font-semibold mb-4" href="{{ route('mylifespot.family.show.emergency_contact',$asset->id) }}">
...
<!--QUESTIONS-->
        <div class="col-span-4 lg:col-span-3 space-y-3 px-4">
          ...
          <div class="py-2 lg:py-6">
            ...
            <div class="pt-8">
                <a href="{{ route('mylifespot.family.show.emergency_contact',$asset->id) }}" class="border border-gray-400 rounded-lg float-right font-semibold text-xs py-2 px-4">Cancel</a>
...
<!--END QUESTIONS-->
        ...
        <div class="col-span-4 lg:col-span-1 xmr-4 px-4">
            <div class="min-h-72  bg-blue-50 rounded-xl p-6">
                ...
                <p class="mt-2 text-xs">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae quidem doloremque facere facilis similique velit libero. Totam consequatur modi sapiente saepe?</p>
            </div>
        </div>
    </div>
</form>
