...
<form method="POST" action="{{ route('mylifespot.family.store.emergency_contact') }}" enctype="multipart/form-data">
    @csrf
...
<!--QUESTIONS-->
        <div class="col-span-4 lg:col-span-3 space-y-3 px-4">
          ...
          <div class="py-2 lg:py-6">
            ...
            <div class="pt-8">
                <a href="{{ route('mylifespot.family.emergency-contacts') }}" class="border border-gray-400 rounded-lg float-right font-semibold text-xs py-2 px-4">Cancel</a>
            ...
            <div class="col-span-4 lg:col-span-1 xmr-4 px-1 lg:px-4">
                <div class="h-72 overflow-y-auto bg-blue-50 rounded-xl p-6">
                    ...
                    <p class="mt-2 text-xs">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolor, labore numquam! Neque dolor suscipit nesciunt earum asperiores perspiciatis id iste iure ratione officiis, vitae, fugiat quae facilis iusto ad ipsa?</p>
                </div>
            </div>
