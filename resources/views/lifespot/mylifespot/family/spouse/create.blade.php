...
<form method="POST" action="{{ route('mylifespot.family.store.spouse') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="grid lg:grid-cols-5 gap-4">
        <div class="col-span-4 lg:col-span-1 xmax-h-48 xw-auto lg:border-r px-2 xmx-4">
            ...
            <div class="lg:bg-gray-50 rounded-lg mt-5 lg:px-2 py-2">
                {{-- <div class="xmt-6">
            ...
            <div class="py-2 lg:py-6">
                ...
                <div class="pt-8">
                    <a href="{{ route('mylifespot.family.spouse') }}" class="border border-gray-400 rounded-lg float-right font-semibold text-xs py-2 px-4">Cancel</a>
