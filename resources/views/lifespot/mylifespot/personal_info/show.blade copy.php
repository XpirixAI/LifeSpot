...
<div class="grid grid-cols-1 lg:grid-cols-5 gap-x-2 gap-y-3 lg:grid-flow-row-dense mx-4">
    <div class="xbg-red-500 rounded-lg xshadow-xl min-h-20 row-span-6">
        ...
        <div class="mt-3">
            <img class="rounded-lg lg:min-h-36 lg:max-h-48  lg:w-auto object-cover" src="{{ (!empty(Auth::user()->profile_photo_path)) ? url('upload/admin_images/'.Auth::user()->profile_photo_path) : url('upload/no_image.png') }}" alt="Profile Image">
        </div>
        ...
        <div class="grid grid-cols-7 gap-2 ">
          <div class="col-span-2 text-right mr-1 xspace-y-3">
            ...
            <div class="space-y-3.5 mr-1">
                <div class="">Phone:</div>
                {{-- <div class=""><span class="hidden lg:inline">Alt</span> Phone<span class="lg:hidden inline">2</span>:</div> --}}
                <div class="">Email:</div>
          ...
          <div class="col-span-5 xspace-y-3 ml-6 lg:ml-0">
            ...
            {{-- <div class="mb-3 text-gray-500 whitespace-nowrap">{{ Str::limit($user->uname, 25, '...') }}</div> --}}
            ...
            <div class="text-gray-500 mt-0 mb-3"> {{ ($user->personalInformation->city ) != NULL || '' ? $user->personalInformation->city .',': '-' }}
           ...
           <div class="space-y-3.5">
            ...
            {{-- <div class="text-gray-500">{{ ($user->personalInformation->alt_phone) != NULL || '' ? $user->personalInformation->alt_phone : '-' }}</div> --}}
            ...
            {{-- <div class="text-gray-500 whitespace-nowrap">{{ ($user->personalInformation->marital_status) != NULL || '' ? $user->personalInformation->marital_status : '-' }}</div> --}}
    ...
    <div class="min-h-72 bg-blue-50 rounded-xl p-6 max-h-80 overflow-y-auto">
       ...
       <p class="mt-2 text-xs">Adding personal profile information is important because it helps create a more personalized presence, which can help people connect with you on a deeper level. It also helps build trust and credibility, and can provide a way for people to contact you directly.</p>
    </div>
                ...
                <div class="xbg-green-400 col-span-3 lg:col-span-3 text-right space-y-3">
                    ...
                    <div class="xbg-blue-400 col-span-5 lg:col-span-7 text-left ml-1 space-y-4 lg:space-y-3 mt-1">
                        <p class="text-gray-500">
                            @isset($spouse[0])
                            {{-- <livewire:spouse-display :asset="$asset"> --}}
...
<div class="grid grid-cols-4 lg:grid-cols-12 gap-x-2 gap-y-3 grid-flow-row-dense mt-2 mx-1">
    <div x-data="{showDocs:false}" class="col-span-2">
        ...
        <div class="rounded-lg shadow-xl bg-sky-500 space-y-2 p-1.5 pl-3 text-gray-50 font-bold">
            <div x-data="{showCustomModal:false}">
                ...
                <div class="text-center"><a @click.prevent="showCustomModal =!showCustomModal" href="#!" class="mx-auto text-sky-900 text-sm">Add Custom</a></div>
                <a @click.prevent="showDocs =!showDocs" class="flex xspace-x-2 cursor-pointer items-center text-center text-xs">
            ...
            <div x-show="showDocs" >
                ...
                <a @click.prevent="showModal =!showModal" href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Birth Certificate</a>
                <a @click.prevent="showTopRightDemoModal =!showTopRightDemoModal" href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Social Security Card
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Driver's License</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Passport</a>
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Marriage License</a>
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Divorce Decree</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Will</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Living Will</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Durable Power of Attorney</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Health Care Proxy</a>
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Life Insurance Policies</a>
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-sky-700">Add Custom</a>
                </a>
    ...
    <div x-data="{showDocs:false}" class="col-span-2">
        <div class="rounded-lg shadow-xl bg-orange-500 space-y-2 p-1.5 pl-3 text-gray-50 font-bold">
            <div>
                ...
                <div class="text-center"><a href="#!" class="mx-auto text-orange-900 text-sm">Add Custom</a></div>
                <a @click.prevent="showDocs =!showDocs" class="flex xxspace-x-2 cursor-pointer items-center text-center text-xs">
                    <span class="mx-auto">Suggested Documents </span>
                    <svg :class="showDocs ? 'hidden' : ''" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                    </svg>
            ...
            <div x-show="showDocs" class="grid grid-cols-2 gap-2">
                ...
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Social Security Card
                </a>

                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Driver's License</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Passport</a>

                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Marriage License</a>
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Divorce Decree</a>

                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Will</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Living Will</a>

                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Durable Power of Attorney</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Health Care Proxy</a>

                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Life Insurance Policies</a>
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-orange-700">Add Custom</a>
            </div>
    ...
    <div x-data="{showDocs:false}" class="col-span-2">
        <div class="rounded-lg shadow-xl bg-yellow-500 space-y-2 p-1.5 pl-3 text-gray-50 font-bold">
            <div>
                <h5 class="font-bold text-lg text-center">Medical</h5>
                <div class="text-center"><a href="#!" class="mx-auto text-yellow-900 text-sm">Add Custom</a></div>
                <a @click.prevent="showDocs =!showDocs" class="flex xspace-x-2 cursor-pointer items-center text-center text-xs">
                    <span class="mx-auto">Suggested Documents </span>
                    <svg :class="showDocs ? 'hidden' : ''" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
            ...
            <div x-show="showDocs" class="grid grid-cols-2 gap-2">
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Birth Certificate</a>
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Immu-nization Records
                </a>

                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Medical Insurance Cards</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">List of Allergies</a>

                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Medical Imaging Results</a>
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Hospital Discharge Summary</a>

                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Physician Notes</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Referral Letters</a>

                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Medical Bills</a>
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">List of Medical Providers</a>

                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Insurance Claims Policies</a>
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Medical Test Results</a>

                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-yellow-700">Add Cusom</a>
                {{-- <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-sm text-center p-1 text-yellow-700"></a> --}}
            </div>
    ...
    <div x-data="{showDocs:false}" class="col-span-2">
        <div class="rounded-lg shadow-xl bg-green-500 space-y-2 p-1.5 pl-3 text-gray-50 font-bold">
            <div>
                ...
                <div class="text-center"><a href="#!" class="mx-auto text-green-900 text-sm">Add Custom</a></div>
                <a @click.prevent="showDocs =!showDocs" class="flex xspace-x-2 cursor-pointer items-center text-center text-xs">
                    <span class="mx-auto">Suggested Documents </span>
                    <svg :class="showDocs ? 'hidden' : ''" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
    ...
    <div x-data="{showDocs:false}" class="col-span-2">
        <div class="rounded-lg shadow-xl bg-teal-500 space-y-2 p-1.5 pl-3 text-gray-50 font-bold">
            <div>
                ...
                <div class="text-center"><a href="#!" class="mx-auto text-teal-900 text-sm">Add Custom</a></div>
                <a @click.prevent="showDocs =!showDocs" class="flex xspace-x-2 cursor-pointer items-center text-center text-xs">
                    <span class="mx-auto">Suggested Documents </span>
                    <svg :class="showDocs ? 'hidden' : ''" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
    ...
    <div x-data="{showDocs:false}" class="col-span-2">
        <div class="rounded-lg shadow-xl bg-blue-500 space-y-2 p-1.5 pl-3 text-gray-50 font-bold">
            <div>
                ...
                <div class="text-center"><a href="#!" class="mx-auto text-blue-900 text-sm">Add Custom</a></div>
                <a @click.prevent="showDocs =!showDocs" class="flex xspace-x-2 cursor-pointer items-center text-center text-xs">
                    <span class="mx-auto">Suggested Documents </span>
                    <svg :class="showDocs ? 'hidden' : ''" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
