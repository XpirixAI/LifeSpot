...
<div class="grid grid-cols-4 lg:grid-cols-12 gap-x-2 gap-y-3 grid-flow-row-dense mt-2 mx-1">
    <div x-data="{showDocs:false}" class="col-span-2">
        <div class="rounded-lg shadow-xl bg-red-500 space-y-2 p-1.5 pl-3 text-gray-50 font-bold">
            <div>
                <h5 class="font-bold text-lg text-center">Personal</h5>
                <div class="text-center"><a href="#!" class="mx-auto text-red-900 text-sm">Add Custom</a></div>
                <a @click.prevent="showDocs =!showDocs" class="flex space-x-2 cursor-pointer items-center text-center text-xs">
            ...
            <div x-show="showDocs" class="grid grid-cols-2 gap-2">
                <a href="#!" class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-red-700">Birth Certificate</a>
                <a href="#!"  class="bg-gray-50 rounded-lg shadow-xl h-20 text-xs text-center p-1 text-red-700">Social Security Card
