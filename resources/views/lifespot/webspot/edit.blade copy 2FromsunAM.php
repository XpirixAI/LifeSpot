...
@section('content')
    ...
    <form method="POST"  action="{{ route('update.webspot', $myxpirix->id) }}" enctype="multipart/form-data" class="grid grid-cols-">
        ...
        @method('PUT')
        <!--My Xpirix NavBar-->
        <div class="flex justify-between px-2 lg:px-8 pt-4 pb-12 text-gray-50 font-bold text-lg bg-{{ $myxpirix->left_color }}">
            ...
            <div class="flex justify-around space-x-4 lg:space-x-16">
                ...
                <span  class="flex space-x-2"><input class="text-black w-3/4 lg:w-1/2 rounded" type="text" name="nav_3" value="{{ $myxpirix->nav_3 }}">
                </span>
        ...
        <!--Full form-->
        <div class="grid grid-cols-2 gap-4 px-6 bg-{{ $myxpirix->left_color }}">
            <!--Left side of form-->
            <div class="col-span-12 lg:col-span-1">
                <div class="m-2">
                    ...
                    <p  class="text-gray-200 text-lg font-bold my-3">Transform how YOU store, share, and upload content.</p>
                    <p class="flex space-x-2"><input class="text-black rounded w-full" type="text" name="line_1" value="{{ $myxpirix->line_1 }}">
                    </p>
                    ...
                    <p  class="text-gray-200 text-lg font-bold my-3">This is YOUR website. Change it EVERYDAY or whenever you wish. Make any parts of it public and or private. You're in control.
                        ...
                        <p class="flex space-x-2"><input class="text-black rounded w-full" type="text" name="line_2" value="{{ $myxpirix->line_2 }}">
                        </p>

                        <p class="text-gray-200 text-lg my-2">Store and organize your favorite recipes, photos, or anything you want.</p>
                        <p class="flex space-x-2"><input class="text-black rounded w-full" type="text" name="line_3"value="{{ $myxpirix->line_3 }}">
                        </p>

                        <p><span class="uppercase text-gray-200 text-lg text-center">Go ahead and customize your world.</span></p>
                        <p class="flex space-x-2"><input class="text-black rounded w-full" type="text" name="line_4" value="{{ $myxpirix->line_4 }}">
                        </p>
                    ...
                    <p :class="showEdit ? '' : 'hidden'" class="flex space-x-2 xmt-12"><input class="text-black rounded w-1/2 lg:w-1/3" type="text" name="cta_button" value="{{ $myxpirix->cta_button }}">
                    </p>
            ...
            <div class="col-span-12 lg:col-span-1">
                <div class="relative top-0 left-0 xh-full">
                    <img id="showImage" class="object-fit rounded-lg min-h-72 h-auto w-full" src="{{ asset('img/Breckenridge2.jpeg') }}">

                    <input xclass="rounded-lg xmax-h-56 h-full w-full" type="hidden" name="oldimage" value="{{ asset('img/Breckenridge2.jpeg') }}">
                    <style>
                        .image-upload>input {
                    display: none;
                    }
