...
<div class="flex justify-center">
    @include('xpirix.body.help_center.xpirix_help.HelpBoxesContent')
    {{-- <div class="grid grid-cols-1 gap-4 md:gap-6 md:grid-cols-2 lg:grid-cols-3 mt-6">
        ...
        <div class="bg-white py-6 px-6 rounded-lg lg:w-64 my-4 shadow-2xl">
            ...
            <h5 class="text-lg font-semibold my-2">How Xpirix can help me grow as a person?</h5>
            <ul>
                <li>
                    <a class="text-blue-700 underline text-xs" href="#!">Investing in your self</a>
                </li>
                <li>
                    <a class="text-blue-700 underline text-xs" href="#!">Finding interests</a>
                </li>
                <li>
                    <a class="text-blue-700 underline text-xs" href="#!">Personal goals and challenges</a>
                </li>
                <li class="">
                    <a class="text-blue-700 underline text-xs" href="#!">Search on Xpirix</a>
                </li>
                <li class="">
                    <a class="text-blue-700 underline text-xs" href="#!">Ask Xpirix "How do I file for Unemployment"</a>
                </li>
            </ul>
            <div class="mt-4 mb-2">
                <a href="#!" class=" text-sm text-white bg-[#0682d4] py-2 px-2 rounded font-black">Browse More LifeSpot</a>
            </div>
        </div>
        <div class="bg-white py-6 px-6 rounded-lg w-64 my-4 shadow-2xl">
            ...
            <h5 class="text-lg font-semibold my-2">Influncers</h5>
            <ul>
                <li>
                    <a class="text-blue-700 underline text-xs" href="#!">How to Influence </a>
                </li>
                <li>
                    <a class="text-blue-700 underline text-xs" href="#!">Create content</a>
                </li>
                <li>
                    <a class="text-blue-700 underline text-xs" href="#!">Create and Ad and share</a>
                </li>
                <li>
                    <a class="text-blue-700 underline text-xs" href="#!">Benefits of Influencing</a>
                </li>
                <li>
                    <a class="invisible text-blue-700 underline text-xs" href="#!">Create and Ad and share</a>
                </li>
                <li>
                    <a class="invisible text-blue-700 underline text-xs" href="#!">Benefits of Influencing</a>
                </li>
                <li>
                    <a class="invisible text-blue-700 underline text-xs" href="#!">Benefits of Influencing</a>
                </li>
        ...
        <div class="bg-white py-6 px-6 rounded-lg w-64 my-4 shadow-2xl">
            ...
            <h5 class="text-lg font-semibold my-2">Market on Xpirix</h5>
            <ul>

                <li>
                    <a class="text-blue-700 underline text-xs" href=""#!>Business Advertising</a>
                </li>
                <li>
                    <a class="text-blue-700 underline text-xs" href=""#!>Manage your Ad space</a>
                </li>
                <li>
                    <a class="text-blue-700 underline text-xs" href="#!">Upgrade your visibility</a>
                </li>

                <li class="invisible">
                    <a class="text-blue-700 underline text-xs" href="#!">Adding Documents to Lifespot</a>
                </li>

                <li class="invisible">
                    <a class="text-blue-700 underline text-xs" href="#!">Adding Docements to Lifespot</a>
                </li>
                <li class="invisible">
                    <a class="text-blue-700 underline text-xs" href="#!">Adding Documents to Lifespot</a>
                </li>
        ...
        <div class="hidden bg-white py-6 px-6 rounded-lg w-64 my-4 shadow-2xl">
            ...
            <h5 class="text-lg font-semibold my-2">XPIRIXWhy LifeSpot is so Private?</h5>
            <ul>
                <li>
        ...
        <div class="hidden bg-white py-6 px-6 rounded-lg w-64 my-4 shadow-2xl">
            ...
            <h5 class="text-lg font-semibold my-2">XPIRIXWill LifeSpot Help us Grow ?</h5>
            <ul>
                <li>
        ...
        <div class="hidden bg-white py-6 px-6 rounded-lg w-64 my-4 shadow-2xl">
            ...
            <h5 class="text-lg font-semibold my-2">XPIRIXWebSpot</h5>
            <ul>
                <li>
