                        ...
                        @if ($post->isPublished=="Published")
                            <div class="pb-4">
                                ...
                                <div  class="col-span-1">
                                    @if ($post->thumbnail)
                                        <img 
                                            class="xw-full xw-auto w-full lg:w-5/6 h-full object-cover rounded-lg mt-4 lg:ml-8"
                                    ...
                                    <div class="accordion" id="accordionExample{{ $post->id }}">
                                        <div class="accordion-item bg-white">
                                            ...
                                            <div 
                                                ...
                                                class="!visible hidden accordion-collapse collapse" 
                                            ...
                                            >
                                                <div class="accordion-body lg:px-5">
                                                    ...
                                                    <button class="text-blue-700 transition"
                                                        ...
                                                        data-te-collapse-init
                                                        data-te-toggle="collapse" 
                                                        data-te-target="#collapseOne{{ $post->id }}" 
                                                        aria-expanded="false"
                                                        aria-controls="collapseOne{{ $post->id }}"
                                                    >
                                                        ...read less
                ...
                <div class="col-span-3 lg:col-span-1 mx-2">
                    @auth
                        <div class="mb-4">
                            ...
                            <p>
                                Create a space that will make you want to stay awhile.
                                <a href="{{ route('webspot') }}" class="text-[#056591] font-semibold">My Xpirix</a>
                                lets you upload blog posts, manage your photos, and explore your interests in a custom-built envirnoment designed by you.
                            </p>
