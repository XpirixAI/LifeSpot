                                ...
                                <div class="max-h-screen grid lg:grid-cols-4 gap-4">
                                    ...
                                    <div class="col-span-4">
                                        <div class="bg-blue-50 rounded-xl p-4">
                                            ...
                                            <p class="mt-2 text-xs"> Aspects of your dependent's health history that could be helpful to emergency medical responders, including allergies and immunization record and family doctor including a main contact phone number can be helpful.</p>
                                        </div>
                                    </div>
                                </div>
        ...
        @isset($medical[0])
            <div id="viewMedicalModal" tabindex="-1" aria-labelledby="viewMedicalModal" aria-hidden="true" class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto">
                ...
                <div
                    ...
                    <div
                    class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                    <h5 class="text-xl font-medium leading-normal text-gray-800" id="viewMedicalModal">Medical info for {{ $asset->fname }}</h5>
                    <button type="button"
            ...
            <div wire:ignore.self id="updateMedicalModal" tabindex="-1" aria-labelledby="updateMedicalModal" aria-hidden="true" class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto">
                ...
                <div class="modal-dialog relative w-auto pointer-events-none">
                    <div
                        ...
                        <div
                            class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                            <h5 class="text-xl font-medium leading-normal text-gray-800" id="updateMedicalModal">Update this Medical Information </h5>
                        </div>
                        <div class="modal-body relative p-4">
