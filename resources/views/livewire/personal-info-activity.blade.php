<div>
    ...
    <div wire:ignore.self id="addUserActivity" tabindex="-1" aria-labelledby="addUserActivityLabel" aria-hidden="true" class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto">
        <div class="modal-dialog relative w-auto pointer-events-none">
            <div
                class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                <div
                    class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                    <h5 class="text-xl font-medium leading-normal text-gray-800" id="addUserActivityLabel">Add your activity info </h5>
                </div>
                <div class="modal-body relative p-4">
                    <form wire:submit.prevent="addUserActivity">
                            ...
                            <div class="max-h-screen grid lg:grid-cols-4 gap-4">
                                ...
                                <div class="col-span-4">
                                    <div class="bg-blue-50 rounded-xl p-4">
                                        ...
                                        <p class="mt-2 text-xs"> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Temporibus eligendi iste a eos soluta! Vitae id nemo aspernatur adipisci aut consequatur possimus non. Totam asperiores enim est labore, commodi dolore?</p>
                                    </div>
                                </div>
                            </div>
    ...
    @isset($activity[0])
        <div id="viewUserActivityModal" tabindex="-1" aria-labelledby="viewUserActivityModal" aria-hidden="true" class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto">
            <div class="modal-dialog relative w-auto pointer-events-none">
            <div
                class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                <div
                class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                <h5 class="text-xl font-medium leading-normal text-gray-800" id="viewUserActivityModal">Activity info for you</h5>
                <button type="button"
                ...
                <h3 class="flex text-lg font-semibold"> {{ $activity[0]->activity_name}}
                    ...
                    <button wire:click="editUserActivity({{ $activity[0]->id }})" type="button" data-bs-toggle="modal" data-bs-target="#updateUserActivityModal" class="flex ml-3 text-xs underline text-gray-500 items-center">Edit</button>
                    <div wire:loading>
                        Processing Data...
                    </div>
    ...
    @isset($activity[0])
        <div wire:ignore.self id="updateUserActivityModal" tabindex="-1" aria-labelledby="updateUserActivityModal" aria-hidden="true" class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto">
            ...
            <div class="modal-dialog relative w-auto pointer-events-none">
                <div
                    ...
                    <div
                        class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                        <h5 class="text-xl font-medium leading-normal text-gray-800" id="updateUserActivityModal">Update this Activity Information </h5>
                    </div>
                    <div class="modal-body relative p-4">
                        <form wire:submit.prevent="updateUserActivity({{ $activity[0]->id }})">
