                            ...
                            <div class="max-h-screen grid lg:grid-cols-4 gap-4">
                                ...
                                <div class="hidden lg:block col-span-4">
                                    <div class="bg-blue-50 rounded-xl p-4">
                                        ...
                                        <p class="mt-2 text-xs"><span class="underline">Guardianship</span> is the legal process of establishing who will step in should you become unable to care for your children or any other person you care for. This could include an elderly parent or other family member, or an adult who is unable to care for themselves. Once a legal guardian steps in, under whatever the circumstances are, he or she would assume all the responsibilities of care. Food, housing, education, medical and other basic needs would be provided by the guardian. Depending on the state you live in, the term “guardian” may be referred to as “conservator” or “tutor.”</p>
                                        <p class="text-xs text-blue-700 mt-5 italic mx-auto text-center">It's important to do your own legal research.  Talk with an attorney.  LifeSpot is not providing legal advice.</p>
                                    </div>
                                </div>
                            </div>
