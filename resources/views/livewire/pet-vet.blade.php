<div>
    ...
    <div wire:ignore.self id="addMedical" tabindex="-1" aria-labelledby="addMedicalLabel" aria-hidden="true" class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto">
        <div class="modal-dialog relative w-auto pointer-events-none">
            <div
                class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                <div
                    class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                    <h5 class="text-xl font-medium leading-normal text-gray-800" id="addMedicalLabel">Add medical info for {{ $asset->fname }}</h5>
                </div>
                <div class="modal-body relative p-4">
                    <form wire:submit.prevent="addMedical">
                            ...
                            <div class="max-h-screen grid lg:grid-cols-4 gap-4">
                                ...
                                <div class="col-span-4 xlg:col-span-5 space-y-3 pb-5">
                                    <div class="lg:flex lg:space-x-2 space-y-4 lg:space-y-0">
                                        ...
                                        <div class="lg:w-full">
                                            <label for="family_doctor" class="block text-sm font-black text-black">Veterinarian</label>
                                            <input type="text" name="family_doctor" wire:model="family_doctor"  autocomplete="family_doctor" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" value="{{ old('family_doctor') }}" placeholder="Veterinarian">
    ...
    @isset($medical[0])
        <div id="viewMedicalModal" tabindex="-1" aria-labelledby="viewMedicalModal" aria-hidden="true" class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto">
            <div class="modal-dialog relative w-auto pointer-events-none">
            <div
                class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                <div
                class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                <h5 class="text-xl font-medium leading-normal text-gray-800" id="viewMedicalModal">Veterinarian info for {{ $asset->fname }}</h5>
                <button type="button"
                ...
                <h3 class="flex text-lg font-semibold"> {{ $medical[0]->family_doctor}}
                    ...
                    <button wire:click="editMedical({{ $medical[0]->id }})" type="button" data-bs-toggle="modal" data-bs-target="#updateMedicalModal" class="flex ml-3 text-xs underline text-gray-500 items-center">Edit</button>
                    <div wire:loading>
                        Processing Data...
                    </div>
                ...
                <button type="button" class="text-right text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none xfocus:ring-gray-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600
                    ...
                    transition
                    duration-150
                    ease-in-out">Delete Veterinarian Info
                </button>
                </div>
            </div>
            </div>
    ...
    @isset($medical[0])
        <div wire:ignore.self id="updateMedicalModal" tabindex="-1" aria-labelledby="updateMedicalModal" aria-hidden="true" class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto">
            ...
            <div class="modal-dialog relative w-auto pointer-events-none">
                <div
                    ...
                    <div
                        class="modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md">
                        <h5 class="text-xl font-medium leading-normal text-gray-800" id="updateMedicalModal">Update this Veterinarian Information </h5>
                    </div>
                    <div class="modal-body relative p-4">
                        <form wire:submit.prevent="updateMedical({{ $medical[0]->id }})">
